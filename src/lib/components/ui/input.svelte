<script lang="ts" module>
	...
	export const input = tv({
		base: "field-focus border-line bg-surface text-text placeholder:text-dim/70 hover:border-line/80 focus:border-accent w-full rounded-md border transition-colors disabled:opacity-50",
		variants: {
			size: {
